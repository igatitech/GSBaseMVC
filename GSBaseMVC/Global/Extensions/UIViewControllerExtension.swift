...
extension  UIViewController {
    ...
    */
    func showAlert(withTitle title: String, withMessage message:String) {
        ...
        let okAction = UIAlertAction(title: StringConstant.Common.kOk, style: .default, handler: nil)
    ...
    */
    func showAlertWithActions(title: String, andMessage message: String , okClickHandler :@escaping(UIAlertAction) -> Void, cancelClickHandler :@escaping(UIAlertAction) -> Void){
        DispatchQueue.main.async {
            ...
            alert.addAction(UIAlertAction(title: StringConstant.Common.kOk, style: UIAlertAction.Style.default, handler: okClickHandler))
            alert.addAction(UIAlertAction(title: StringConstant.Common.kCancel, style: UIAlertAction.Style.cancel, handler: cancelClickHandler))
