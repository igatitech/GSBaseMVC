...
class PendingOrderTableCell: UITableViewCell {
    ...
    //MARK:- Custom Methods
    func setUpView() {
        self.labelDateTitle.setUpLabel(title: StringConstant.MyOrder.orderOn, titleColor: .appTextBlack, titleFont: GetAppFont(FontType: .Gilmer_Regular, FontSize: .Regular))
        ...
        self.labelPaymentTitle.setUpLabel(title: StringConstant.MyOrder.paymentStatus, titleColor: .appTextBlack, titleFont: GetAppFont(FontType: .Gilmer_Regular, FontSize: .Regular))
        self.labelTotalTitle.setUpLabel(title: StringConstant.MyOrder.total, titleColor: .appTextBlack, titleFont: GetAppFont(FontType: .Gilmer_Regular, FontSize: .Regular))
        self.labelOrderId.setUpLabel(title: "", titleColor: .white, titleFont: GetAppFont(FontType: .Gilmer_Bold, FontSize: .Regular))
        self.labelOrderDate.setUpLabel(title: "", titleColor: .appTextBlack, titleFont: GetAppFont(FontType: .Montserrat_Bold, FontSize: .Regular))
        self.labelPaymentStatus.setUpLabel(title: "", titleColor: .appTextBlack, titleFont: GetAppFont(FontType: .Montserrat_Bold, FontSize: .Regular))
        self.labelTotal.setUpLabel(title: "", titleColor: .appTextBlack, titleFont: GetAppFont(FontType: .Montserrat_Bold, FontSize: .Regular))
    ...
    func setUpData() {
        ...
        if let paymentStatus = pendingData?.payment_status {
            if paymentStatus == StringConstant.MyOrder.pending {
                self.labelPaymentStatus.textColor = .appOrange
            } else {
                self.labelPaymentStatus.textColor = .appGreen
            }
        }
